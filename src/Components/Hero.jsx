        ...
        <div className='dark:bg-slate-900'>
            <div className='h-fit lg:h-[87vh] w-[80%] mx-auto flex flex-col lg:flex-row justify-between items-center pt-10 lg:pt-0 '>
                <div className='flex-1'>
                    ...
                    <h3 className='text-[#252b46] dark:text-white text-[40px] font-semibold italic text-center lg:text-left'>
                        Tune Up your Business
                    </h3>
                    <p className='text-[#252b46] dark:text-white mt-2 font-semibold text-[16px] text-center lg:text-left'>
