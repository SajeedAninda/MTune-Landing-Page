        ...
        <div className='dark:bg-slate-900'>
            <div className='h-fit lg:h-[100vh] w-[80%] mx-auto'>
                <div className=''>
                    ...
                    <p className='text-[24px] text-[#252b46] dark:text-white font-semibold mt-2 text-center'>
                    ...
                    {activeTab === 1 && (
                        <div className='tab-1 flex flex-col lg:flex-row justify-between items-center pt-8'>
                            <div className="flex-1">
                                ...
                                <p className='text-[22px] text-[#252b46] dark:text-white font-medium mt-2 text-left'>
