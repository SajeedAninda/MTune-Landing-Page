        ...
        <div className='dark:bg-slate-900'>
            <div className='h-fit lg:h-screen w-[80%] mx-auto'>
                <div className='pt-6'>
                    ...
                    <p className='text-[24px]  dark:text-white font-semibold mt-2 text-center'>
                ...
                <div className='flex flex-col lg:flex-row justify-between items-center pt-8'>
                    <div className="flex-1">
                        ...
                        <p className='text-[22px] text-[#252b46] dark:text-white font-medium mt-2 text-center lg:text-left'>
